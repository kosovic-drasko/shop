package infinityshopping.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, infinityshopping.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, infinityshopping.repository.UserRepository.USERS_BY_EMAIL_CACHE);
