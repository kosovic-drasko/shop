...
import infinityshopping.repository.PaymentRepository;
import infinityshopping.service.PaymentService;
...
/**
 * REST controller for managing {@link infinityshopping.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
