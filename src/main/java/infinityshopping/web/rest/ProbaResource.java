...
import infinityshopping.service.ProbaQueryService;
import infinityshopping.service.ProbaService;
...
/**
 * REST controller for managing {@link infinityshopping.domain.Proba}.
 */
@RestController
@RequestMapping("/api")
