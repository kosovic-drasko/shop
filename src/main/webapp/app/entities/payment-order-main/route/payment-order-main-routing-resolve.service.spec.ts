...
describe('PaymentOrderMain routing resolve service', () => {
  ...
  let resultPaymentOrderMain: IPaymentOrderMain | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPaymentOrderMain).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPaymentOrderMain>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
