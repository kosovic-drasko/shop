...
export class PaymentCartRoutingResolveService implements Resolve<IPaymentCart | null> {
  constructor(protected service: PaymentCartService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IPaymentCart | null | never> {
    const id = route.params['id'];
    if (id) {
      return this.service.find(id).pipe(
        mergeMap((paymentCart: HttpResponse<IPaymentCart>) => {
          if (paymentCart.body) {
