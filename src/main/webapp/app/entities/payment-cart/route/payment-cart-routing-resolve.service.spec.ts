...
describe('PaymentCart routing resolve service', () => {
  ...
  let resultPaymentCart: IPaymentCart | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPaymentCart).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPaymentCart>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
