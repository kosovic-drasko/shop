...
describe('ShipmentCart routing resolve service', () => {
  ...
  let resultShipmentCart: IShipmentCart | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultShipmentCart).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IShipmentCart>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
