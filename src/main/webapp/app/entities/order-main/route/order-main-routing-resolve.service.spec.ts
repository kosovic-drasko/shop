...
describe('OrderMain routing resolve service', () => {
  ...
  let resultOrderMain: IOrderMain | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOrderMain).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOrderMain>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
